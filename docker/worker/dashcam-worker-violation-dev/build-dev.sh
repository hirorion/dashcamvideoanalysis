...
docker build --build-arg APP_USER_ID=1000 --build-arg APP_USER_NAME=mitsui --build-arg APP_GROUP_ID=1000 --no-cache --target=development -t "dashcam/worker/violations:1.0-dev" .
